...
package com.muddykat.hrst.client.helper;
...
public class HRSTRecipeBuilder<R extends HRSTRecipeBuilder<R>> implements FinishedRecipe {
	...
	protected HRSTRecipeBuilder(RecipeSerializer<?> serializer) {
	...
	public HRSTRecipeBuilder<R> addWriter(Consumer<JsonObject> writer) {
		Preconditions.checkArgument(this.id == null, "This recipe has already been finalized");
		this.writerFunctions.add(writer);
		return this;
	}

	public HRSTRecipeBuilder<R> addCondition(ICondition condition) {
	...
	public HRSTRecipeBuilder<R> setTime(int time) {
		return this.addWriter((jsonObject) -> {
			jsonObject.addProperty("time", time);
		});
	}

	public HRSTRecipeBuilder<R> setEnergy(int energy) {
		return this.addWriter((jsonObject) -> {
			jsonObject.addProperty("energy", energy);
		});
	}

	public HRSTRecipeBuilder<R> setMultipleResults(int maxResultCount) {
	...
	public HRSTRecipeBuilder<R> addMultiResult(JsonElement obj) {
	...
	public HRSTRecipeBuilder<R> addResult(ItemLike itemProvider) {
		return this.addResult(new ItemStack(itemProvider));
	}

	public HRSTRecipeBuilder<R> addResult(ItemStack itemStack) {
		return this.resultArray != null ? this.addMultiResult(this.serializeItemStack(itemStack)) : this.addItem("result", itemStack);
	}

	public HRSTRecipeBuilder<R> addResult(Ingredient ingredient) {
	...
	public HRSTRecipeBuilder<R> addResult(IngredientWithSize ingredientWithSize) {
	...
	public HRSTRecipeBuilder<R> setUseInputArray(int maxInputCount, String key) {
	...
	public HRSTRecipeBuilder<R> setUseInputArray(int maxInputCount) {
		return this.setUseInputArray(maxInputCount, "inputs");
	}

	public HRSTRecipeBuilder<R> addMultiInput(JsonElement obj) {
	...
	public HRSTRecipeBuilder<R> addMultiInput(Ingredient ingredient) {
		return this.addMultiInput(ingredient.toJson());
	}

	public HRSTRecipeBuilder<R> addMultiInput(IngredientWithSize ingredient) {
	...
	public HRSTRecipeBuilder<R> addInput(ItemLike... itemProviders) {
	...
	public HRSTRecipeBuilder<R> addInput(ItemStack... itemStacks) {
	...
	protected HRSTRecipeBuilder<R> addSimpleItem(String key, ItemLike item) {
		return this.addWriter((json) -> {
			json.addProperty(key, BuiltInRegistries.ITEM.getKey(item.asItem()).toString());
		});
	}

	public HRSTRecipeBuilder<R> addItem(String key, ItemLike item) {
		return this.addItem(key, new ItemStack(item));
	}

	public HRSTRecipeBuilder<R> addItem(String key, ItemStack stack) {
	...
	public HRSTRecipeBuilder<R> addIngredient(String key, ItemLike... itemProviders) {
		return this.addIngredient(key, Ingredient.of(itemProviders));
	}

	public HRSTRecipeBuilder<R> addIngredient(String key, ItemStack... itemStacks) {
		return this.addIngredient(key, Ingredient.of(itemStacks));
	}

	public HRSTRecipeBuilder<R> addIngredient(String key, TagKey<Item> tag) {
		return this.addIngredient(key, Ingredient.of(tag));
	}

	public HRSTRecipeBuilder<R> addIngredient(String key, Ingredient ingredient) {
		return this.addWriter((jsonObject) -> {
			jsonObject.add(key, ingredient.toJson());
		});
	}

	public HRSTRecipeBuilder<R> addIngredient(String key, IngredientWithSize ingredient) {
		return this.addWriter((jsonObject) -> {
			jsonObject.add(key, ingredient.serialize());
		});
	}

	public HRSTRecipeBuilder<R> addFluid(String key, FluidStack fluidStack) {
		return this.addWriter((jsonObject) -> {
			jsonObject.add(key, ApiUtils.jsonSerializeFluidStack(fluidStack));
		});
	}

	public HRSTRecipeBuilder<R> addFluid(FluidStack fluidStack) {
		return this.addFluid("fluid", fluidStack);
	}

	public HRSTRecipeBuilder<R> addFluid(Fluid fluid, int amount) {
		return this.addFluid("fluid", new FluidStack(fluid, amount));
	}

	public HRSTRecipeBuilder<R> addFluidTag(String key, FluidTagInput fluidTag) {
		return this.addWriter((jsonObject) -> {
			jsonObject.add(key, fluidTag.serialize());
		});
	}

	public HRSTRecipeBuilder<R> addFluidTag(String key, TagKey<Fluid> fluidTag, int amount) {
		return this.addFluidTag(key, new FluidTagInput(fluidTag, amount, (CompoundTag)null));
	}

	public HRSTRecipeBuilder<R> addFluidTag(TagKey<Fluid> fluidTag, int amount) {
