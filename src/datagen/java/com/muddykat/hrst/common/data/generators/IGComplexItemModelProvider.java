...
import com.muddykat.hrst.common.data.TRSRModelBuilder;
...
public class IGComplexItemModelProvider extends ModelProvider<TRSRModelBuilder>
{
	...
	{
		super(output, HRSTLib.MODID, ITEM_FOLDER, TRSRModelBuilder::new, existingFileHelper);
	}
	...
	{
		generateMultiblockModel("rotarykiln", HRSTMultiblockProvider.HRHTPortal.block());
	}
