...
package com.muddykat.hrst.client.models;
...
@EventBusSubscriber(modid = HRSTLib.MODID, bus = Bus.MOD, value = Dist.CLIENT)
public class HRSTDynamicModel
{
	...
	public HRSTDynamicModel(String desc)
	{
		// References a generated json file
		this.name = new ResourceLocation(HRSTLib.MODID, "dynamic/"+desc);
